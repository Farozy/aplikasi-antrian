...
class NoAntrianDataModel extends Model
{
    protected $table = 'no_antrian';
    protected $column_order = [null, 'no_antrian', null, null];
    protected $column_search = ['no_antrian'];
    protected $order = ['id_no_antrian' => 'asc'];
    // protected $requests;
    protected $db;
    protected $dt;
