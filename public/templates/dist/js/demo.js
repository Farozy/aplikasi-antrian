...
(function ($) {
  ...
  var $dark_mode_checkbox = $('<input />', {
    ...
    if ($(this).is(':checked')) {
      ...
      $('.main-sidebar').addClass('sidebar-dark-light');
      $('.main-sidebar').removeClass('sidebar-light-dark');
      $('.main-header').removeClass('navbar-light');
      $('.main-header').addClass('navbar-dark');
    } else {
      $('body').removeClass('dark-mode')
      $('.main-sidebar').removeClass('sidebar-dark-light');
      $('.main-sidebar').addClass('sidebar-light-dark');
  ...
  var navbar_all_colors = navbar_dark_skins
